        ...
        <div class="registration-view__form">
                  ...
                  <div class="registration-view__form-error-messages">
                    ...
                    <Message
                      ...
                      v-if="
                        ...
                        showPasswordErrors
                      "
                      >{{ messageValidationPasswordLength }}</Message
                    >
                    <Message
                      severity="error"
                      v-if="
                        ...
                        showPasswordErrors
                      "
                      >{{ messageValidationSpecialCharacter }}</Message
                    >
                    <Message
                      severity="error"
                      v-if="
                        ...
                        showPasswordErrors
                      "
                      >{{ messageValidationDigitNumber }}</Message
                    >
                    <Message
                      severity="error"
                      v-if="
                        ...
                        showPasswordErrors
                      "
                      >{{ messageValidationCapitalLetter }}</Message
                    >
                    <Message
                      severity="error"
                      v-if="
                        ...
                        showPasswordErrors
                      "
                      >{{ messageValidationSmallLetter }}</Message
                    >
                    <Message
                      severity="error"
                      v-if="
                        ...
                        showPasswordErrors
                      "
                      >{{ messageValidationNoWhitespaces }}</Message
                    >
                  </div>
                </template>
              </Password>
          ...
          <div class="registration-view__form-input">
            <FloatLabel variant="on">
              <Password
                ...
                :invalid="
                  !isPasswordRepeatedValid && showPasswordRepeatedErrors
                "
                :feedback="false"
              >
              </Password>
            ...
            <div class="registration-view__form-error-messages">
              <Message
                severity="error"
                v-if="!passwordRepeated && showPasswordRepeatedErrors"
                >{{ messageInputRequired }}</Message
              >
              <Message
                severity="error"
                v-if="
                  passwordRepeated &&
                  (!password ||
                    !validatePasswordsMatch(password, passwordRepeated)) &&
                  showPasswordRepeatedErrors
                "
                >{{ messageValidationPasswordsMatch }}</Message
              >
            </div>
          </div>
          ...
          <div class="registration-view__form-input profile-view__form-section">
            ...
            <div
              ...
              :key="ix"
              class="registration-view__form-input-instruments"
            >
              <div
                class="registration-view__form-input-instrument-header registration-view__text-color"
              >
                Instrument: {{ ix + 1 }}
                <i
                  class="pi pi-trash"
...
const isPasswordRepeatedValid = computed(
  () =>
    passwordRepeated.value &&
    (!password.value ||
      validatePasswordsMatch(password.value, passwordRepeated.value)),
)
