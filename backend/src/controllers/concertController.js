...
const getAllMembersAvailabilityInConcert = async (req, res) => {
    ...
    try {
        ...
        const membersAvailability =
            await ConcertModel.getAllMembersAvailabilityByConcertId(concertId)
...
module.exports = {
    ...
    getAllMembersAvailabilityInConcert,
    createConcert,
